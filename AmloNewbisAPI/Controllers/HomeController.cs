...
namespace AmloNewbisAPI.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async ValueTask<IActionResult> Index()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        return Redirect($"{Configuration["AppSettings:Login:BlaLogin"]}");
                    }

                }
                var user = GetUerInfo(N_USERID);
                ViewBag.link = Configuration["AppSettings:RedirectURL"];
        ...
        private ZTB_USER GetUerInfo(string N_USERID)
        {
            ...
            var client = new RestClient($"{Configuration["AppSettings:Link:DocumnetStorageAPI"]}");
